...
def push_all_to_sheet(shippers_json_payload):
    """सारे शिपर का JSON डेटा और Base64 टेम्पलेट्स गूगल शीट पर सिंगल-रो फॉर्मेट में सेव करता है"""
    try:
        payload = {
...
def load_template_bytes_from_sheet(shipper_name):
    """गूगल शीट के JSON डेटा से शिपर की Base64 फाइल को डिकोड करके बाइट्स लौटाता है"""
